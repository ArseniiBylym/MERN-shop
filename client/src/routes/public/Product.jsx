...
import {Reviews, Spinner} from '../../components/views';
...
export const Product = withRouter(
    observer(props => {
        ...
        const loadProductDetails = async () => {
            try {
                setIsFetching(true);
                await ProductAction.getProductDetails(props.match.params.prodId);
        ...
        if (fetchedFailed) return <h2>No product found</h2>;
        if (fetchedSuccess)
            return (
                <Fragment>
                    <div className="Product row m-3">
                        <div className="Product__header d-flex flex-wrap align-items-center justify-content-between w-100 mx-3 text-primary_black">
